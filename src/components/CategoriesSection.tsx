...
const categories = [
  { icon: ShoppingCart, title: "E-Commerce", count: "2,450+", description: "Full-featured online stores", color: "bg-primary/10 text-primary" },
  { icon: Briefcase, title: "Business", count: "1,820+", description: "Corporate & professional sites", color: "bg-accent/10 text-accent" },
  { icon: Layout, title: "Landing Pages", count: "3,200+", description: "High-converting pages", color: "bg-primary/10 text-primary" },
  { icon: FileText, title: "Portfolios", count: "1,560+", description: "Showcase your work", color: "bg-accent/10 text-accent" },
  { icon: Palette, title: "Creative", count: "2,100+", description: "Unique artistic designs", color: "bg-primary/10 text-primary" },
  { icon: Smartphone, title: "Mobile Apps", count: "980+", description: "App landing templates", color: "bg-accent/10 text-accent" },
];
